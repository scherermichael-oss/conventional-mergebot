...
| `AUTOMERGE_DEPENDABOT_MODULE_PREFIX` |                           | Prefix of the name of that will be merged automatically if all checks are ok                                                                                                         |
| `AUTOMERGE_DEPENDABOT_UPDATE_TYPES`  |                           | Comma-separated list of update types will be merged automatically if all checks are ok. Possible values: `major`, `premajor`, `minor`, `preminor`, `patch`, `prepatch`, `prerelease` |
